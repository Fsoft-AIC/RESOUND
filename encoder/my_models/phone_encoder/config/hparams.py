...
import os
# ### dataset ###
with open("/cm/shared/khanhpl2/ISUlatest_mine/multi_target_lip2speech/my_models/phone_encoder/config/dataset.yaml", "r") as f:
    dataset_config = yaml.load(f, Loader=yaml.FullLoader)

# with open("my_models/phone_encoder/config/dataset.yaml", "r") as f:
#      dataset_config = yaml.load(f, Loader=yaml.FullLoader)
